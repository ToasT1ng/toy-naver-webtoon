...
VALUES (1, '슬기로운 코딩 생활', '오늘도 우리는 코딩을 한다. 별볼일 없어보이는 IT 회사원의 하루 하루.', 4, 100192, 4.90,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/1/main.png', '', 'wed', 'serialize',
        false),
       (2, '로얄독',
        ...
        1, 53932, 4.74, 'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/2/main.png', '', 'wed',
        'serialize', false),
       (3, '스페이스쉽 메이비',
        ...
        5, 72012, 4.88, 'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/3/main.png', '', 'wed',
        'serialize', false),
       (4, '안녕, 아빠', '미혼부인 아버지와 초등학생 딸의 이야기. 아빠, 사랑해.', 4, 1012, 4.99,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/4/main.png', '', 'wed', 'serialize',
        false),
       (5, '비오는날', '비오는날의 이야기', 3, 19812, 4.11,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/5/main.png',
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/5/recommend.png', 'wed', 'serialize',
        false),
       (6, '옆집친구', '옆집 친구와 로맨스', 2, 233391, 4.89,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/6/main.png',
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/6/recommend.png', 'wed', 'serialize',
        false),
       (7, '제우스', '근엄한 제우스', 6, 9813, 3.33,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/7/main.png',
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/7/recommend.png', 'wed', 'serialize',
        false),
       (8, '어느날 자고 일어나니 내가 게임 속에 빠져있었다', '이게 무슨 일이야?! 자기 전에 한 게임 속에 들어와 있다!', 5, 198763, 4.65,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/8/main.png',
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/8/recommend.png', 'wed', 'serialize',
        false),
       (9, '널 만난뒤로 내 삶은', '많이 달라졌지', 2, 210863, 4.99,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/9/main.png',
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/9/recommend.png', 'wed', 'serialize',
        false),
       (10, '순옥공주', '외척 세력을 압박하려는 임금과 외척 세력을 두둔하는 황후 사이에서 태어난 귀중한 딸. 자, 딸아 넌 누구 편을 들거니?', 6, 911733, 4.98,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/10/main.png', '', 'wed', 'serialize',
        false),

       (11, '어느날 지구가', '지구가 화가 난걸까? 2029년 7월 19일. 갑자기 적도 위치가 바뀌었다. 장소는 아이슬란드! 적도가 바뀐 그 순간. 아비규환이었던 그날의 기록.', 7, 987311,
        4.99,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/11/main.png', '', 'wed', 'serialize',
        false),
       (12, '13월',
        ...
        5, 999999, 5.00,
        'https://github.com/ToasT1ng/toy-naver-webtoon-imgs/blob/main/thumbnail/12/main.png', '', 'wed', 'serialize',
        false)
;
